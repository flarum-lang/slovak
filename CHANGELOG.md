...
* Odstránené zastaralé preklady Flarum core (podporovaná je verzia `2.0` alebo vyššia).
* Odstránené zastaralé preklady validácie (podporovaná je verzia `2.0` alebo vyššia).
...
**Aktualizované a/alebo odstránené zastaralé preklady pre rozšírenia**:
...
**Odstránená podpora pre zastaralé rozšírenia**:
...
Všetky zmeny: [v1.4.0...v2.0.0](https://github.com/flarum-lang/slovak/compare/v1.4.0...v2.0.0).
